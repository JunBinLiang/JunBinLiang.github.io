...
let Header = class Header {
    constructor(registersService, loginService) {
    ...
    ngOnInit() {
        ...
        this.authenticatedStateSub = this.loginService.getAuthenticatedUpdate().subscribe((authenticate) => {
    ...
    smalldisappear1() {
        setTimeout(() => {
            if (this.smallshow && !this.smallenter) {
                this.smallmenu5 = false;
                setTimeout(() => {
                    this.smallmenu4 = false;
                    setTimeout(() => {
    ...
    smallappear() {
        if (!this.smallshow) {
            ...
            setTimeout(() => {
                this.smallmenu2 = true;
                setTimeout(() => {
                    this.smallmenu3 = true;
                    setTimeout(() => {
                        this.smallmenu4 = true;
                        setTimeout(() => {
                            this.smallmenu5 = true;
                            this.smallshow = true;
                        }, 100);
                    }, 100);
                }, 100);
...
let Register = class Register {
    ...
    loadRegister() {
        ...
        setTimeout(() => {
            this.registersService.setFillInformation(true);
            this.fillInformation = true;
        }, 500);
    }
    ngOnInit() {
        // console.log("Register Init");
        this.registerStateSub = this.registersService.getRegisterUpdateListener().subscribe((state) => {
            this.fillInformation = state;
            this.registerState = true;
            //console.log("update",this.fillInformation);
        });
        this.repeatUserSub = this.registersService.getrepeatUserStateUpdate().subscribe((repeat) => {
            console.log("repeat user");
            this.repeatUser = repeat;
        });
...
let Chat = class Chat {
    constructor(loginService, http, route) {
        this.loginService = loginService;
        this.http = http;
        this.route = route;
        this.enterValue = "";
    ...
    ngOnInit() {
        this.route.paramMap.subscribe((paramMap) => {
            this.currentUserId = paramMap.get("currentUserid");
            this.friendid = paramMap.get("friendid");
            console.log(this.currentUserId, this.friendid);
        });
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.currentUserId }).subscribe(response => {
            this.currentUser = response.user;
            this.http.post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.friendid }).subscribe(response => {
                this.friend = response.user;
            });
        });
        this.interval = setInterval(() => {
            this.http.post("https://peaceful-mountain-59628.herokuapp.com/getchat", { friendid: this.friendid }).subscribe(response => {
                this.chat = response.chat;
                this.chatcontent = response.chat.content;
    ...
    send(form) {
        ...
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/chat", { currentuserid: this.currentUserId, friendid: this.friendid, content: form.value.content }).subscribe(response => {
        });
        this.enterValue = "";
    }
    ngOnDestroy() {
        clearInterval(this.interval);
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/deletechatrequest", { friendid: this.friendid }).subscribe(response => {
        });
    }
};
Chat.ctorParameters = () => [
...
let GetPosts = class GetPosts {
    ...
    ngOnInit() {
        ...
        this.route.paramMap.subscribe((paramMap) => {
            if (paramMap.has("userid")) {
                ...
                this.http.post("https://peaceful-mountain-59628.herokuapp.com/getposts", { userId: this.userId }).subscribe(response => {
                    //console.log(response.posts);
                    this.posts = response.posts;
                    this.http.post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.userId }).subscribe(response => {
    ...
    deletepost(event) {
        ...
        let deletepostid = event.target.value;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/deletepost", { deleteid: deletepostid }).subscribe(response => {
            this.http.post("https://peaceful-mountain-59628.herokuapp.com/getposts", { userId: this.userId }).subscribe(response => {
                //console.log(response.posts);
                this.posts = response.posts;
            });
...
LoginInterceptor.ctorParameters = () => [
    { type: _loginservice__WEBPACK_IMPORTED_MODULE_2__["Loginservice"] }
];
...
let Loginservice = class Loginservice {
    ...
    getAuthenticatedUpdate() {
        return this.authenticatedUpdate.asObservable();
    }
    logOut() {
        //console.log("logout");
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/logout", { userid: this.userid }).subscribe(response => {
        });
        this.clearAuthData();
    ...
    login(formValue) {
        let email = formValue.myemail;
        let password = formValue.mypassword;
        this.http
            .post("https://peaceful-mountain-59628.herokuapp.com/login", { email: email, password: password }).subscribe(response => {
            //get back the token if login is succed
            this.token = response.token;
            if (this.token) {
                const expiresInDuration = response.expiresIn;
                this.logoutAutomatically(expiresInDuration); //a timer
...
let MyPage = class MyPage {
    ...
    ngOnInit() {
        ...
        this.route.paramMap.subscribe((paramMap) => {
            if (paramMap.has("userid")) {
                this.userid = paramMap.get("userid");
                this.http
                    .post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.userid }).subscribe(user => {
                    this.user = user.user;
                    this.requestNumber = this.user['friendRequest'].length;
                    this.chatRequestNum = this.user['chatRequest'].length;
                    this.friendRequestId = [...this.user['friendRequest']];
                    ...
                    //console.log("err",err); 
                    setTimeout(() => { this.loading = false; this.userUnfind = true; }, 300);
                });
            }
        });
        this.interval = setInterval(() => {
    ...
    accept(e) {
        ...
        let acceptId = e.target.value;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/acceptOrReject", { acceptOrReject: "accept", who: acceptId }).subscribe(response => {
            this.user = response.user;
            //console.log("user",this.user);
            this.friendRequestId = [...this.user['friendRequest']];
            this.http.post("https://peaceful-mountain-59628.herokuapp.com/getFriendRequest", { friendRequest: this.friendRequestId }).subscribe(response1 => {
                this.resultUsers = [...response1.users];
                this.requestNumber = this.user['friendRequest'].length;
            });
        });
    }
    reject(e) {
        let rejectId = e.target.value;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/acceptOrReject", { acceptOrReject: "reject", who: rejectId }).subscribe(response => {
            this.user = response.user;
            this.friendRequestId = [...this.user['friendRequest']];
            this.http.post("https://peaceful-mountain-59628.herokuapp.com/getFriendRequest", { friendRequest: this.friendRequestId }).subscribe(response1 => {
                this.resultUsers = [...response1.users];
    ...
    showRequest() {
        ...
        this.chatpage = false;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/getFriendRequest", { friendRequest: this.friendRequestId }).subscribe(response => {
            this.resultUsers = [...response.users];
    ...
    loadFriends() {
        ...
        this.pageIndex = 0;
        this.pageSize = 2;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/getFriendRequest", { friendRequest: this.user['friends'] }).subscribe(response => {
            //getback the friends
            this.pageShowFriends = [];
            this.friends = [];
            this.friends = [...response.users];
            //console.log(this.friends);
            this.pageFriendsNum = this.friends.length;
    ...
    loadchat() {
        ...
        this.chatpage = true;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/getFriendRequest", { friendRequest: this.user['chatRequest'] }).subscribe(response => {
            //console.log("chat",response.users);
            this.chatUsers = [...response.users];
        });
    }
    acceptChat(e) {
        ...
        let path = "/chat/" + this.userid + "/" + friendid;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/deletechatrequest", { friendid: friendid }).subscribe(response => {
            this.router.navigate([path]);
        });
    }
    gotoChat(e) {
...
let Post = class Post {
    ...
    handlePost(form) {
        ...
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/savePost", { title: title, content: content }).subscribe(response => {
            let path = "./mypage/" + this.currentUserId;
            this.router.navigate([path]);
        });
    }
};
...
let Registerservice = class Registerservice {
    ...
    addUser(formValue) {
        ...
        this.http
            .post("https://peaceful-mountain-59628.herokuapp.com/addUser", userData).subscribe(result => {
            console.log(result.message);
            this.router.navigate(["/login"]);
        }, err => {
            console.log("some error happen", err);
            this.repeatUserStateUpdate.next(true);
        });
    }
};
...
let Search = class Search {
    constructor(searchService, loginService, http) {
    ...
    ngOnInit() {
        ...
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.currentuserid }).subscribe(response => {
            this.currentUser = response['user']; //get the current user
        ...
        this.usersSubscription = this.searchService.gerUsersUpdateListener()
            ...
            this.loading = true;
            setTimeout(() => { this.loading = false; this.paginStart = true; }, 500);
            this.usersShow = [];
            this.notFound = false;
            this.resultUsers = users.users;
            //console.log("init",this.resultUsers);
            this.length = users.users.length;
    ...
    addFriend(form) {
        let target = form.value.userid;
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/addFriend", { currentUser: this.currentuserid, target: target }).subscribe(response => {
            console.log("okoko");
            this.http.post("https://peaceful-mountain-59628.herokuapp.com/getUsers", { searchValue: this.searchValue }).subscribe(users => {
                this.loading = true;
                setTimeout(() => { this.loading = false; this.paginStart = true; }, 100);
                this.usersShow = [];
                this.notFound = false;
                this.resultUsers = users.users;
                this.length = users.users.length;
                ...
                this.http.post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.currentuserid }).subscribe(response => {
                    this.currentUser = response['user']; //update the current user after add friends
                });
            });
        });
    }
    onSubmit() {
        ...
        this.http.post("https://peaceful-mountain-59628.herokuapp.com/singleUser", { userid: this.currentuserid }).subscribe(response => {
            this.currentUser = response['user']; //update the current user after add friends
            this.searchService.search(searchValue); //search
        });
    }
    ngOnDestroy() {
...
let SearchService = class SearchService {
    ...
    gerUsersUpdateListener() {
        return this.usersUpdateListener;
    }
    search(searchValue) {
        this.http
            .post("https://peaceful-mountain-59628.herokuapp.com/getUsers", { searchValue: searchValue }).subscribe(users => {
            //console.log("users",users);
            //this.users=users;
            //fetching all the user.
            console.log("search service", users);
            this.usersUpdateListener.next(users);
        }, err => {
            console.log(err);
        });
    }
